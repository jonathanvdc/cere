...
def compile_memory_dump_objects(mode_opt, DIR):
    if not mode_opt.static:
        DUMP_ARGS="-Wl,--section-start=.text=0x60004000 -Wl,--section-start=.init=0x60000000 -Wl,--section-start=.interp=0x80000000"
    else:
        DUMP_ARGS="-Wl,--section-start=.text=0x6004000 -Wl,--section-start=.init=0x6000000 -Wl,--section-start=.interp=0x80000000"
